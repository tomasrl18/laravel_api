...
@section('content')
    <div class="flex justify-between items-center mb-10 mt-10">
        <h2 class="uppercase">Categories List</h2>
        ...
        @foreach($categories as $category)
            <tr>
                ...
                <td class="options-container">
                    <a href="{{ route('category.edit', $category->id) }}" class="mr-2 hover:opacity-80 actions">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
                            <path fill="#333333"
                                  d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83l3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75z"/>
                        </svg>
                    </a>
                    <a href="{{ route('category.show', $category->id) }}" class="mr-2 hover:opacity-80 actions">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
                            <path fill="#333333"
